...
public class RecyclerViewAdapter extends ArrayAdapter<CoronaItem> {
    ...
    public RecyclerViewAdapter(Context context, ArrayList<CoronaItem> coronaItemArrayList) {
        super(context, R.layout.activity_main, coronaItemArrayList);
        this.context = context;
        this.coronaItemArrayList = coronaItemArrayList;
    }

    public View getViem(@NonNull int position, View view, ViewGroup parent){
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position)
    {
        ...
        String lastUpdt = coronaItem.getLastUpdate();
